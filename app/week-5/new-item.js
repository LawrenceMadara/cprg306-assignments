...
export default function NewItem() {
    ...
    let incButton = "bg-yellow-600 hover:bg-green-700 text-white rounded px-3";
    ...
    return(
        ...
        >
            ...
            <div>
                <button 
                type="submit" 
                className="w-full mt-4 py-2 px-4 bg-yellow-600 text-white font-bold rounded-lg hover:bg-green-700">
                Submit
                </button>
            </div>
